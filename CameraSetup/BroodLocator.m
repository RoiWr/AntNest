...
% find and read data files of previous BroodLocators
    ...
    handles.Data.path = 'D:\NestConstructionExp\BroodLocationData\';
    addpath(handles.Data.path)
    addpath('D:\NestConstructionExp\Scripts') % add Scripts folder to path
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
cd 'D:\NestConstructionExp\BroodLocationData'
...
files = dir('D:\NestConstructionExp\DailyTemp2\*.jpg');
...
Destination = strcat('D:\NestConstructionExp\',nestID);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    [FileName,PathName,~] = uigetfile('D:\NestConstructionExp\DailyTemp2\*.jpg','Select Image');
...
function FindLastPopNo(handles)
   ...
   % Initialize variables.
    filename = ['D:\NestConstructionExp\BroodLocationData\',tag,'_Population.csv'];
    delimiter = ',';
    startRow = 2;
